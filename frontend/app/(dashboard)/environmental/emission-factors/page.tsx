import { Leaf, Bell, Search, Plus, ListFilter, ChevronDown, Database, Clock, FileText, Upload, ArrowUp, ArrowDown } from "lucide-react"
...
import { mockEmissionFactors } from "@/lib/mock-data/environmental"
      ...
      <main className="flex-1 p-8">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            ...
            <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col justify-between h-[135px]">
              ...
              <div className="flex flex-col mt-auto">
                <span className="text-[32px] font-bold text-[#191C1E] tracking-tight leading-none">12,482</span>
                <span className="text-[12px] text-[#0D631B] font-semibold mt-1 flex items-center gap-0.5">
                  <ArrowUp className="h-3 w-3 stroke-[2.5]" /> +124 this month
                </span>
              </div>
            </div>
            ...
            <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col justify-between h-[135px]">
              ...
              <div className="flex flex-col mt-auto">
                <span className="text-[32px] font-bold text-[#191C1E] tracking-tight leading-none">4.2 Mo</span>
                <span className="text-[12px] text-[#707A6C] font-semibold mt-1">
                  Last global sync: 3d ago
                </span>
              </div>
            </div>
            ...
            <div className="rounded-[16px] border border-[#E2E8F0] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] flex flex-col justify-between h-[135px]">
              <div className="flex items-start justify-between">
                <span className="text-[12px] font-bold uppercase tracking-[0.05em] text-[#707A6C]">Custom Sets</span>
                <div className="rounded-lg bg-[#F2ECF7] p-1.5 text-[#7A2FAA]">
                  <FileText className="h-4 w-4" />
                </div>
              </div>
              <div className="flex flex-col mt-auto">
                <span className="text-[32px] font-bold text-[#191C1E] tracking-tight leading-none">18</span>
                <span className="text-[12px] text-[#7A2FAA] font-semibold mt-1">
                  4 sets pending review
                </span>
              </div>
            </div>
          ...
          <div className="overflow-hidden rounded-[16px] border border-[#E2E8F0] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.02)] space-y-6">
            ...
            {/* Table Header Pills and Count */}
            <div className="flex items-center justify-between border-b border-[#E2E8F0] pb-4">
              <div className="flex gap-2">
                <button className="rounded-[6px] bg-[#0D631B] px-4 py-1.5 text-[12px] font-bold text-white transition-colors">
                  ALL
                </button>
                <button className="rounded-[6px] border border-[#E2E8F0] bg-[#E1E2E4]/40 px-4 py-1.5 text-[12px] font-bold text-[#40493d] hover:bg-[#D2D3D5]/60 transition-colors">
                  FUEL
                </button>
                <button className="rounded-[6px] border border-[#E2E8F0] bg-[#E1E2E4]/40 px-4 py-1.5 text-[12px] font-bold text-[#40493d] hover:bg-[#D2D3D5]/60 transition-colors">
                  ELECTRICITY
                  ...
                  {mockEmissionFactors.map((factor) => {
                    ...
                    return (
                      <TableRow key={factor.id} className="h-[52px] border-b-[#E2E8F0] hover:bg-[#F7F8FA]/50">
                        <TableCell className="text-[13px] font-semibold text-[#191C1E]">{factor.activity_type}</TableCell>
                        <TableCell className="text-[13px] text-[#40493d] font-medium">{getSector(factor.activity_type)}</TableCell>
                        <TableCell className="text-[13px] text-[#0D631B] font-bold text-right">{factor.co2_per_unit.toFixed(4)}</TableCell>
            ...
            <div className="flex items-center justify-between border-t border-[#E2E8F0] pt-4">
              ...
              <div className="flex items-center gap-2">
                <Button disabled variant="outline" className="h-[32px] px-3 border-[#E2E8F0] text-[#707A6C] rounded-[6px] text-[12px] font-semibold">
                  Prev
                </Button>
                <span className="h-8 w-8 rounded-[6px] bg-[#0D631B] text-white flex items-center justify-center text-[12px] font-bold">
                  1
                </span>
                <span className="h-8 w-8 rounded-[6px] text-[#40493d] hover:bg-[#E2E8F0]/50 flex items-center justify-center text-[12px] font-bold cursor-pointer transition-colors">
                  2
                </span>
                <Button variant="outline" className="h-[32px] px-3 border-[#E2E8F0] text-[#40493d] rounded-[6px] text-[12px] font-semibold hover:bg-[#F7F8FA]">
                  Next
                </Button>
              </div>
            </div>
